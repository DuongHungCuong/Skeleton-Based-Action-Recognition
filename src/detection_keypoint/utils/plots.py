...
colors = Colors()  # create instance for 'from miscellaneous_utils.plots import colors'
...
def plot_val_txt():  # from miscellaneous_utils.plots import *; plot_val()
...
def plot_targets_txt():  # from miscellaneous_utils.plots import *; plot_targets_txt()
...
def plot_study_txt(path='', x=None):  # from miscellaneous_utils.plots import *; plot_study_txt()
...
def profile_idetection(start=0, stop=0, labels=(), save_dir=''):
    # Plot iDetection '*.txt' per-image logs. from miscellaneous_utils.plots import *; profile_idetection()
...
def plot_evolve(evolve_csv='path/to/evolve.csv'):  # from miscellaneous_utils.plots import *; plot_evolve()
...
def plot_results(file='path/to/results.csv', dir=''):
    # Plot training results.csv. Usage: from miscellaneous_utils.plots import *; plot_results('path/to/results.csv')
